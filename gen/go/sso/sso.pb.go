...
type LoginRequest struct {
	...
	AppId    int64  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // Id of the app to login to. User register in one place and
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token to logged user
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // Indicates whether user_id is admin
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x6e, 0x65, 0x76, 0x7a, 0x6f, 0x72, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
